...
<head>
    ...
    <link rel="stylesheet" href="fonts/Univers/Univers.otf">
    <link rel="stylesheet" href="fonts/Univers/Univers-Light.otf">
    <link rel="stylesheet" href="fonts/Univers/Univers-BoldExt.otf">
    <link rel="stylesheet" href="fonts/Univers/Univers-BoldExt.otf">
</head>
<body>
    ...
    <section id="home" class="d-flex justify-content-center align-items-center">
        <div class="container principal">
            <a href="#inicio" class="btn-1">Más Información</a>
        </div>
    </section>
    ...
    <div id="inicio" class="d-flex justify-content-center align-items-cente py-5">
        <div class="container">
                <div class="col">
                    <h2>¡Iniciamos en septiembre!</h2>
                    <p>Duración <span>de 1 año 4 meses</span> de 8:00 a 14:00 horas
                    </p>
                </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 contact container-1 shadow" id="contact_form">
                    <div class="container">
                        <div class="row">
                            <div class="col-12 contact header py-4">
                                <p>Completa el formulario para recibir mas información y atención personalizada</p>
